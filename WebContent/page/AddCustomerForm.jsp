            ...
            <div class="col-md-8">
              <div class="card">
				...
				<form action="../AddCustomerServlet" method="POST" >
					...
					<input class="form-control" type="text" name="CustomerId" required>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Customer Telephone</label>
						<input class="form-control" name="CustomerPhone" type="text" required>
						</div>
                      </div>
                      ...
                      <div class="col-md-6">
						...
						<input class="form-control" name="CustomerAddress" type="text" required>
                    	</div>
                      </div>
                    </div>
