            ...
            <div class="col-md-8">
              <div class="card">
				...
				<form action="../UpdateUserServlet" method="POST" >
					...
					<input class="form-control" type="text" name="username"  value="<%=u.getUserName() %>" readonly>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Email</label>
						  <input class="form-control" type="text" name="email" value="<%=u.getEmail() %>"required>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
						...
						<input class="form-control" name="password" type="text" value="<%=u.getPassword() %>"required>
						</div>
                      </div>
                      ...
                      <div class="col-md-6">
						...
						<input class="form-control" name="name" type="text" value="<%=u.getName() %>"required>
                    	</div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
						...
						<input class="form-control" name="role" type="text" value="<%=u.getRole() %>" required>
                    	</div>
                      </div>
                    </div>
