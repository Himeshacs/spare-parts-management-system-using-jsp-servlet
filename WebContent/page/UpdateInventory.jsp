      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <img src="Images/inventory.png" alt="inventory" height="0100" width="0100"/>
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                ...
                <div class="card-body">
				<form name="inventory" action="PostUpdateInventoryServlet" method="POST">
      			<% Inventory inventory =(Inventory)request.getAttribute("inventory"); %>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          	<label> Inventory ID :</label> <br>
							<input type ="text" name="inventoryID" placeholder="format is Ixxxx" maxlength="5" class ="form-control" value="<%= inventory.getInventoryID() %>">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          	<label> Product ID :</label> <br>
							<input type ="text" name="productID"  maxlength="5" class ="form-control" value="<%= inventory.getProductID() %>"> 
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
							...
							<input type ="number" name="instoreInventory"  onFocus="startCalc();" onBlur="stopCalc();" maxlength="5" class ="form-control" value="<%= inventory.getClosingInventory() %>">  <br>
						</div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
							...
							<input type ="number" name="unitsPurchased"  onFocus="startCalc();" onBlur="stopCalc();" maxlength="20" class ="form-control" value="">
                    	</div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
							...
							<input type ="number" name="unitsSold" onFocus="startCalc();" onBlur="stopCalc();" maxlength="10" class ="form-control" value="">
                    	</div>
                      </div>
                    </div>
                     ...
                     <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
							...
							<input type ="number" name="closingInventory"  maxlength="10" readonly class ="form-control" value="">
                    	</div>
                      </div>
                       ...
                       <div class="col-md-6">
                        <div class="form-group">
                          <label> Update Date : </label> <br>
							<input type ="date" name="updateDate"  maxlength="12" class ="form-control" value="<%= inventory.getUpdateDate() %>"> 
                    	</div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
							...
							<input type ="time" name="updateTime"  maxlength="8" class ="form-control" value="<%= inventory.getUpdateTime() %>"> 
                    	</div>
                      </div>
                    ...
                    <input type="submit" value="Update Inventory" onclick="popFunction()" class="btn btn-primary btn-block" >
