	...
	<head>
 		...
 		<script type="text/javascript">
			...
			function popFunction() {
				  alert("New Purchase is Added to the System");
				}
		</script>
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                ...
                <div class="card-body">
				<form name="purchase" action="../AddPurchaseServlet" method="POST" >
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          	<label> Purchase ID :</label> <br>
							<input type ="text" name="purchaseID" placeholder="format is Pxxxx" maxlength="5" class ="form-control" required>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          	<label> Supplier ID :</label> <br>
							<input type ="text" name="supplierID"  maxlength="5" class ="form-control" required>  
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
							...
							<input type ="text" name="productID"  maxlength="5" class ="form-control" required>  <br>
						</div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
							...
							<input type ="number" name="unitPrice"  onFocus="startCalc();" onBlur="stopCalc();" maxlength="8" class ="form-control" required>
                    	</div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
							...
							<input type ="number" name="totalQuantity" onFocus="startCalc();" onBlur="stopCalc();" maxlength="10" class ="form-control" required>
                    	</div>
                      </div>
                    </div>
                     ...
                     <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
							...
							<input type ="number" name="subTotal" maxlength="10"  readonly class="form-control">
                    	</div>
                      </div>
                       ...
                       <div class="col-md-6">
                        <div class="form-group">
                          	<label> Purchase Status : </label>
								<select name="purchaseStatus" class ="form-control" required>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
							...
							<input type ="date" name="purchaseDate"  maxlength="8" class ="form-control" required> 
                    	</div>
                      </div>
                    ...
                    <input type="submit" value="Add Purchase" onclick="popFunction()" class="btn btn-primary btn-block" >
