          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                ...
                <div class="card-body">
				<form action="PostUpdateSupplierServlet" method="POST" >
				<% Supplier supplier =(Supplier)request.getAttribute("supplier"); %>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          	<label> Supplier ID :</label> <br>
							<input class ="form-control" type ="text" name="supplierID" placeholder="format is Sxxxx" maxlength="5" value="<%= supplier.getSupplierID() %>"> 
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          	<label> Company Name :</label> <br>
							<input class ="form-control" type ="text" name="companyName"  maxlength="20" value="<%=supplier.getCompanyName()%>">
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
							...
							<input class ="form-control" type ="text" name="contactPerson"  maxlength="20" value="<%=supplier.getContactPerson()%>">
						</div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          	...
                          	<input type="text" name="email" maxlength="20" class="form-control" value="<%=supplier.getEmail() %>">
                    	</div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
							...
							<input class ="form-control" type ="text" name="contactNumber"  maxlength="10" value="<%=supplier.getContactNumber()%>"> 
                    	</div>
                      </div>
                    </div>
                     ...
                     <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
							...
							<input class ="form-control" type ="text" name="companyAddress"  maxlength="30" value="<%=supplier.getCompanyAddress()%>"> 
                    	</div>
                      </div>
                    </div>
                    
                    <input type="submit" value="Update Supplier" onclick="popFunction()" class="btn btn-primary btn-block" >
