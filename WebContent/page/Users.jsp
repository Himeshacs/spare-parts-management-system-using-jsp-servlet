  ...
  <div class="wrapper ">
    <div class="sidebar" data-color="purple" data-background-color="white" data-image="../assets/img/sidebar-1.jpg">
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          <li class="nav-item   ">
            <a class="nav-link" href="${pageContext.request.contextPath}/page/dashboard.jsp">
              <i class="material-icons">dashboard</i>
              <p>Dashboard</p>
            </a>
          </li>
          <li class="nav-item active ">
            <a class="nav-link" href="${pageContext.request.contextPath}/page/Users.jsp">
          ...
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Users</a>
                      <div class="col-md-btn">
                  		<form action="AddUserForm.jsp" method="POST"><input type="submit" value="Add Users" class="btn btn-primary btn-block" >
                     	</form>         
                      </div>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category"> User Overview</p>
                </div>
                <div class="card-body">
                        ...
                        <td>
						 <li class="nav-item dropdown">
			                ...
			                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
								<form action="${pageContext.request.contextPath}/DeleteUserServlet?username='<%=u.getUserName() %>'" method="post">
											                <button style="height: 29px;padding-right: 93px;"> DELETE</button> 
								
								</form>
							<form action="${pageContext.request.contextPath}/page/UpdateUserForm.jsp?username='<%=u.getUserName() %>'" method="post">
											                <button style="height: 30px;padding-right: 98px;"> Update</button> 
