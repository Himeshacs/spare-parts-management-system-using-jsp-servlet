...
function validateForm() {
  var x = document.forms["myForm"]["productId"].value;
  if (x.length != 6) {
    alert("Product id should be a 6 character word");
    return false;
  }
}
</script>
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                ...
                <div class="card-body">
				<form action="../AddProductServlet" name="myForm" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                    <div class="row">
                      <div class="col-md-6">
